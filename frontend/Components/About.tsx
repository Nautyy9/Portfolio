...
function About() {
  ...
  return (
    ...
    >
      <div className="my-10  w-full xss:w-11/12   items-center mx-auto lg:w-5/6   flex flex-col md+:flex-row">
        <div className="flex  flex-col   justify-center  gap-y-4 w-full   ">
          ...
          <div className="flex flex-col gap-y-2 sm:gap-y-4 w-5/6  self-center">
            <p className=" font-medium text-lg  xs:text-xl  w-auto">
              ...
              <div className="w-full h-full relative ">
                ...
                >
                  ...
                  <div className="shaded absolute w-full h-[40%]  -bottom-14 bg-gradient-to-b from-gray-200 to-black  opacity-90  justify-center items-center  flex-col flex">
                    <div className="flex">
                      <h1 className="text-white text-xl xs:text-3xl">
                        My Resume
                      </h1>
              ...
              <div className="h-full ">
                ...
                >
                  <div className=" flex  items-center relative">
                    <h1 className="text-white drop-shadow-lg text-base xs:text-xl md:text-3xl absolute xs:ml-2  ">
                      MY RESUME
                    </h1>
                    <div className="flex h-max w-full xs:mr-2 flex-col mt-5 items-end  text-white text-xl  text-center  [&>*]:border-t-8 [&>*]:drop-shadow-sm [&>*]:w-1/2 [&>*]:border-[#f5e4bc]  gap-y-6">
                      <span></span>
                      <span></span>
                    </div>
                  </div>
                  <div className="head flex  w-full h-full ">
                    <div className="w-1/2 relative flex flex-col justify-around items-center ">
                      <AboutUtils content="EDUCATION" />
                      <AboutUtils content="EXPERIENCE" />
                      <div className=" absolute bottom-2 left-2 flex  justify-center items-center border-[#f4805b] border-2 p-1 xs:px-2  ">
                        <p className=" text-white  text-center text-base xs:text-xl ">
                          Click to download
                        </p>
                        <HiOutlineDownload
                          size={25}
                          className=" h-max w-max inset-0 md:border-0 rounded-full border-2 border-[#f4805b] p-1 xs:p-2 ml-3  text-[#f4805b]"
                        ></HiOutlineDownload>
                      </div>
                    </div>
