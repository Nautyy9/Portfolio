          ...
          >
              ...
              >
                <div className="  flex justify-center md+:justify-start w-full">
                  ...
                  >
                    ...
                    <div className="hidden md+:flex w-full  z-50 text-[#171717] justify-center  md+:flex-col  md+:flex-nowrap lg:flex-row flex-wrap gap-4 object-contain">
                      <img
                        onClick={() => {
              ...
              >
                <div className=" flex justify-center md+:justify-start w-full">
                  ...
                  >
                    ...
                    <div className="hidden md+:flex font-bellota flex-col lg:flex-row justify-center flex-nowrap gap-4 object-contain">
                      <img
                        onClick={() => {
                          if (activeImg.current)
                            activeImg.current.src =
            ...
            >
              ...
              >
                  ...
                  >
                    ...
                    <div className=" flex gap-5 justify-center mx-auto  md+:gap-10">
                      <div className="h-12 w-12  lg+:h-20 lg+:w-20   ">
                        <NextSvg from="work" className="h-full w-full" />
                      </div>
                      <div className="h-12 w-12  lg+:h-16 lg+:w-16   ">
                        <FramerSvg from="work" className="h-full w-full" />
                      </div>
                      <div className="h-12 w-12 lg+:h-16 lg+:w-16 ">
                        <TsSvg from="work" className="h-full w-full" />
                      </div>
                ...
                <div className="  w-full md+:h-2/3 md+:my-auto  justify-center md+:justify-end md+:items-center flex ">
                  <a target="_blank" href="https://mukul-nainwal.vercel.app/">
                    <div
                      ref={imgdiv3_ref}
                      className={`md+:mt-14 lg:mt-0    bg-cover
                      ${
              ...
              >
                <div className=" flex justify-center md+:justify-start w-full">
                  ...
                  >
                    ...
                    <div className=" flex gap-5 justify-center mx-auto  md+:gap-10">
                      <div className="h-12 w-12  lg+:h-16 lg+:w-16   ">
                        <ReduxSvg from="work" className="h-full w-full" />
                      </div>
                      <div className="h-12 w-12  lg+:h-16 lg+:w-16   ">
                        <ReactQuerySvg from="work" className="h-full w-full" />
                      </div>
                      <div className="h-12 w-12  lg+:h-16 lg+:w-16   ">
                        <ReactSvg from="work" className="h-full w-full" />
                      </div>
                ...
                <div className="  w-full md+:h-2/3 md+:my-auto  justify-center md+:justify-end md+:items-center flex ">
                  <a target="_blank" href="https://poke-app-woad.vercel.app/">
                    <div
                      ref={imgdiv4_ref}
                      className={`md+:mt-14 lg:mt-0    bg-cover
                      ${
              ...
              >
                <div className=" flex justify-center md+:justify-start  w-full">
                  ...
                  >
                    ...
                    <span className="hidden md+:block border-2 border-[#292823] xl+:font-semibold text-red-600 px-4 py-2 text-lg tracking-wide">
                    ...
                    <div className="hidden md+:flex flex-col  lg:flex-row justify-center flex-nowrap gap-4 object-contain">
                      <img
                        onClick={() => {
                          if (activeImg.current)
                            activeImg.current.src =
              ...
              >
                <div className=" flex justify-center md+:justify-start w-full">
                  ...
                  >
                    ...
                    <div className=" tracking-wide text-[#171717] text-xl justify-center flex md+:flex-col lg:flex-row flex-nowrap md+:flex-wrap gap-4 object-contain">
                      <span className="border-2 border-[#171717] w-max font-semibold   text-red-600 px-4 py-2">
